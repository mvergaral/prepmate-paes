...
class TestStudentModel(BaseTestCase):
    def test_student_creation(self):
        with self.app.app_context():
            _, student = UserFactory.create_student(email='b@b.com', name='Estudiante', rut='2-7', age=20)
...
class TestAdminModel(BaseTestCase):
    def test_admin_creation(self):
        with self.app.app_context():
            user, admin = UserFactory.create_admin(email='admin@admin.com', name='Admin', rut='3-3', age=30, accepted_terms=True)
